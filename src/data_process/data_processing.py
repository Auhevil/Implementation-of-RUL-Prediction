...
def data_processing(data_name="FD001", smooth_param=1, exclude=False):
    ...
    index_names = ['unit_nr', 'time_cycles']  # number of engin unit + it's cycles
    setting_names = ['setting_1', 'setting_2', 'setting_3']  # 3 settings of engine
    sensor_names = ['s_{}'.format(i) for i in range(1, 22)]  # 21 sensors
    ...
    # select the sensors and drop non-informative features in training set
